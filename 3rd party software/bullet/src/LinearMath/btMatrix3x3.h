...
public:
	...
	* @param m The array to be filled */
	...
	{
#if defined BT_USE_SIMD_VECTOR3 && defined (BT_USE_SSE_IN_API) && defined (BT_USE_SSE)
        //KKonecko: TODO OPTIMIZATION Figure out why this is crashing!
        ...
        /*
         ...
         vm[2] = v2;
         */
        //KKonecko: remove this and replace it with the code above. Disabeling this for now to allow IOS to work correctly
