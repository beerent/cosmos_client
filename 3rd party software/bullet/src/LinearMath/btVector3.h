...
// this code is not faster !
   ...
   * Note return values are 0,1,2 for x, y, or z */
	...
	{
        //kkonecko causes odd behavior in character controller See note in character controler!
        //This is the second time we have issues on ipads only using sse instructions we need a atask to investigate this!
