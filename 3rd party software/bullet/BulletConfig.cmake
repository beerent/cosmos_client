...
set ( BULLET_FOUND 1 )
set ( BULLET_USE_FILE     "/Library/Frameworks/lib/cmake/bullet/UseBullet.cmake" )
set ( BULLET_DEFINITIONS  "" )
set ( BULLET_INCLUDE_DIR  "/Library/Frameworks/include/bullet" )
set ( BULLET_INCLUDE_DIRS "/Library/Frameworks/include/bullet" )
set ( BULLET_LIBRARIES    "LinearMath;BulletCollisions;BulletDynamics;BulletSoftBody" )
set ( BULLET_LIBRARY_DIRS "/Library/Frameworks/lib" )
set ( BULLET_ROOT_DIR     "/Library/Frameworks" )
